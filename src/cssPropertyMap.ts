export const cssPropertyMap = {
  ...
  top: ["string", "number", "auto", "inherit", "initial", "unset"],
  right: ["string", "number", "auto", "inherit", "initial", "unset"],
  bottom: ["string", "number", "auto", "inherit", "initial", "unset"],
  left: ["string", "number", "auto", "inherit", "initial", "unset"],
  ...
  margin: ["auto", "inherit", "initial", "unset", "string", "number"],
  marginTop: ["auto", "inherit", "initial", "unset", "string", "number"],
  marginRight: ["auto", "inherit", "initial", "unset", "string", "number"],
  marginBottom: ["auto", "inherit", "initial", "unset", "string", "number"],
  marginLeft: ["auto", "inherit", "initial", "unset", "string", "number"],
  padding: ["inherit", "initial", "unset", "string", "number"],
  paddingTop: ["inherit", "initial", "unset", "string", "number"],
  paddingRight: ["inherit", "initial", "unset", "string", "number"],
  paddingBottom: ["inherit", "initial", "unset", "string", "number"],
  paddingLeft: ["inherit", "initial", "unset", "string", "number"],
